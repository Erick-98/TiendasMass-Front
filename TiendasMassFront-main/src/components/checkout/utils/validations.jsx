// Validaciones para los campos del formulario de checkout
...
export const validators = {
  ...
  address: (value, deliveryType) => {
    // Solo validar si el tipo de entrega es 'delivery'
  ...
  reference: (value) => {
    // La referencia es opcional, solo validar longitud si existe
  ...
  selectedStore: (value, deliveryType) => {
    // Solo validar si el tipo de entrega es 'pickup'
...
export const validateField = (fieldName, value, extraContext = {}) => {
  ...
  // Algunos validadores necesitan contexto extra (como deliveryType)
  if (fieldName === 'address' || fieldName === 'city' || fieldName === 'zipCode' || 
      fieldName === 'country' || fieldName === 'selectedStore') {
